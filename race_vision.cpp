...
int main(int argc, char **argv)
{
  ...
  // return 1;
   ...
   VideoCapture cap(pipeline, cv::CAP_GSTREAMER); /////////// 여기
   ...
   ros::init(argc, argv, "m_race_vision"); /////////// 여기
   ...
   */
   ...
   ros::Publisher car_control_pub_cmd = nh.advertise<std_msgs::Int16>("Car_Control_cmd/V_SteerAngle_Int16", 10); //////////////여기
